      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="container relative z-10 px-4 py-20">
          <div className="max-w-4xl mx-auto text-center space-y-8 animate-fade-in">
            <Link
              to="/"
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 text-primary mb-4 hover:opacity-80 transition-opacity"
            >
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Experience the rich cultural heritage of Fulani music. Stream
              authentic rhythms, discover talented artists, and connect with
        ...
        <div className="container max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground">
              Connecting you to the heart of Fulani culture
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="card-gradient p-8 rounded-xl border border-border hover:border-primary/50 transition-colors">
              ...
              <p className="text-muted-foreground">
                Access your favorite Fulani tracks anytime, anywhere with our
                seamless streaming platform.
              </p>
            </div>
            ...
            <div className="card-gradient p-8 rounded-xl border border-border hover:border-primary/50 transition-colors">
              ...
              <p className="text-muted-foreground">
                Explore talented Fulani musicians and discover new voices from
                across West Africa.
              </p>
            </div>
            ...
            <div className="card-gradient p-8 rounded-xl border border-border hover:border-primary/50 transition-colors">
              ...
              <p className="text-muted-foreground">
                Immerse yourself in the rich musical traditions and stories of
                the Fulani people.
              </p>
            </div>
          </div>
        ...
        <div className="container max-w-4xl mx-auto">
          <div className="card-gradient p-12 rounded-2xl border border-primary/20 text-center">
            ...
            <p className="text-muted-foreground mb-8">
              Join MusiquePeulh today and experience authentic West African
              music.
            </p>
            {isAuthenticated ? (
              <Button
